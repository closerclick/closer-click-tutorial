/**
 * @closerclick/closer-click-tutorial
 *
 * UI compartida del ecosistema CloserClick para hacer TUTORIALES / onboarding
 ...
 * donar/compartir (`<closer-click-support>`), pero apuntando a elementos reales
 ...
 *
 * Filosofía CloserClick: autohosteado, Shadow DOM, sin JS de terceros ni
 ...
 *   <closer-click-tutorial lang="es"></closer-click-tutorial>
 *   const el = document.querySelector('closer-click-tutorial')
 *   el.steps = [...]; el.start()
 *
 * --- Vanilla (jsDelivr) ----------------------------------------------------
 *   <script type="module"
 *     src="https://cdn.jsdelivr.net/npm/@closerclick/closer-click-tutorial@0.1/src/index.js"></script>
 *
...
class CloserClickTutorial extends HTMLElement {
...
/**
 * Crea (o reutiliza) un `<closer-click-tutorial>` y arranca el tour.
...
function createTutorial (options = {}) {
  ...
  if (!el) {
    el = document.createElement('closer-click-tutorial')
...
if (typeof customElements !== 'undefined' && !customElements.get('closer-click-tutorial')) {
  customElements.define('closer-click-tutorial', CloserClickTutorial)
}

export { CloserClickTutorial, createTutorial }
