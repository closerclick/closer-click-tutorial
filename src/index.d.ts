...
export interface CcTutorialOptions {
  ...
  element?: CloserClickTutorial
  el?: CloserClickTutorial
...
export declare class CloserClickTutorial extends HTMLElement {
  steps: CcTutorialStep[]
...
export declare function createTutorial (options: CcTutorialOptions): CloserClickTutorial

export default createTutorial

declare global {
  interface HTMLElementTagNameMap { 'closer-click-tutorial': CloserClickTutorial }
